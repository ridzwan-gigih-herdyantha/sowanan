...
export const invitation = {
  ...
  gallery: [
    { src: img("g-1"), w: 1200, h: 1530, alt: "Sekar mencubit pipi Bagas sambil tertawa" },
    { src: img("g-2"), w: 1400, h: 933, alt: "Sekar menyentuh wajah Bagas dengan buket di tangan" },
    { src: img("g-3"), w: 1200, h: 975, alt: "Bagas dan Sekar di bawah pepohonan" },
    { src: img("g-5"), w: 1200, h: 1800, alt: "Bagas dan Sekar duduk di tangga" },
    { src: img("g-4"), w: 1200, h: 971, alt: "Bagas dan Sekar di dua ayunan" },
    { src: img("g-6"), w: 1200, h: 1012, alt: "Sekar tertawa menatap Bagas" },
  ],
  gifts: [
